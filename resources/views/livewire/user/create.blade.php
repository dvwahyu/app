<div>
    <form class="kt-form kt-form--fit kt-form--label-right" wire:submit.prevent="submit">
        ...
        <div class="kt-portlet__foot kt-portlet__foot--fit-x">
            <div class="kt-form__actions">
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <button type="submit" wire:target="submit" wire:loading.attr="disable" class="btn btn-primary"> 
