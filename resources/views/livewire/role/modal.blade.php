<!-- Modal -->
<div class="modal" id="roleModal{{ $role->id }}" tabindex="-1" role="dialog" aria-labelledby="roleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
    <div class="modal-content">
        ...
        <div class="justify-content-center align-self-center mb-3">
            ...
            <button wire:click="destroy({{ $role->id }})" wire:loading.attr="disable" class="btn btn-danger">
